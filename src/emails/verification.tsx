...
export function VerificationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Hi {name}, We noticed a recent attempt to Register for a 🔐Auth account
        with your email. If this was you
      </Preview>
      <Body style={main}>
        <Container>
          <Section style={logo}>
          ...
          <Section style={content}>
            ...
            <Row style={{ ...boxInfos, paddingBottom: "0" }}>
              <Column>
                ...
                >
                  We noticed a recent attempt to Register for a 🔐Auth account
                  with your email.
                </Heading>
