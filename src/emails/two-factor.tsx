...
export const TwoFactorEmail = ({ token, name }: TwoFactorEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>
        Hi {name}, We noticed a recent attempt to login to your 🔐Auth account.
        If this was you
      </Preview>
      <Body style={main}>
        <Tailwind>
              ...
              <Row style={{ ...boxInfos, paddingBottom: "0" }}>
                <Column>
                  ...
                  <Heading as="h2" className="text-2xl font-semibold">
                    We noticed a recent attempt to login to your 🔐Auth account.
                    If this was you, please enter the following code to complete
                    the login process.
                  </Heading>
                  ...
                  <Text className="text-xl mt-3">
                    ...
                    <br />
                    <span className="text-2xl mt-2 font-bold tracking-wider">
                      {token}
                    </span>
                    <br />
